...
public class _01_HashSet {
    public static void main(String[] args) {
        ...
        int[] dizi=new int[5]; // hafızada 5 sayı tutar
        ...
        // Bana artık elemanları gelişi güzel miktarınca tutan değil , aynı elemanları tutmayan
        // yani bir elemandan sadece 1 tane olan diziler lazım. hangi sırada olduğunun bir önemi yok

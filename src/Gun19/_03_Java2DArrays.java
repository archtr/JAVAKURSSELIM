...
public class _03_Java2DArrays {
    public static void main(String[] args) {
        ...
        int[] dizi2={34,56,77}; // 1 boyutlu diziye başlangıç değerleri vererek tanımladık

        // 2 ders , 3 öğrencilik bilgileri bir arada tutacak tablo lazım.
        int[][] tablo1=new int[2][3]; // 2 satır 3 sütunluk veri , yani 6 elemanlı bir tanımlama yaptım.

...
public class _07_JavaString {
    public static void main(String[] args) {
        ...
        String ad="ismet"; // String ifadelerin sayı gibi bir sınırı olmadığından "" tırnak ile sınırı belli edilir.
        String soyad="Temur"; // Temur\0 özel karakter koyarak sınırını belirliyor
